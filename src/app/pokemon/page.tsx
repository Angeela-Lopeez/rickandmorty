...
export default async function PokemonList() {
    // ❗ Descomenta esta línea solo para probar el Error Handler
    // throw new Error("Error simulado para probar el Error Handler");
        ...
        <div className="p-8">
            <div className="max-w-6xl mx-auto">
                <h1 className="text-4xl font-bold text-white text-left mb-12 drop-shadow-lg">
                    <IoMdList size={40} className="inline-block mr-2" />
